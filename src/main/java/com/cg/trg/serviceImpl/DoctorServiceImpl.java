...
import com.cg.trg.dao.DoctorRepository;
import com.cg.trg.service.DoctorService;
...
public class DoctorServiceImpl implements DoctorService {
    ...
    @Override
    public Doctor updateDoctor(String userName, Doctor doctor1) {   // doctor1 (data coming from postman), doctor(data coming from database)
        Doctor doctor = doctorRepository.findByUserName(userName);
